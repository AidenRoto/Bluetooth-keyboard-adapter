/* Copyright (C) 2016 LSChyi. All rights reserved.
 ...
 */
#if !defined(__BT_HIDBOOT_H__)
#define __BT_HIDBOOT_H__
...
class BtMouseReportParser : public HIDReportParser {
...
class BtKeyboardReportParser : public HIDReportParser {
...
protected:
        ...
        virtual void OnKeyDown(uint8_t mod, uint8_t key, uint8_t buf[]) {
        };

        virtual void OnKeyUp(uint8_t mod, uint8_t key, uint8_t buf[]) {
        };
